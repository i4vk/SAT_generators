...
# generator_list = generator_list[30:60]
# print("Generator list: ", len(generator_list))

input_dim = 2 # 2 node types
edge_features = 2
model = locals()[args.model](input_dim=input_dim, feature_dim=args.feature_dim,
                hidden_dim=args.hidden_dim, output_dim=args.output_dim, num_edge_features=edge_features,
