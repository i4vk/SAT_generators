...
# def generate_one_graph(generator, i, model, outdir, args, repeat):
#     time0 = time.time()
#     time_model = 0
#     generator.reset()
#     while True:
...
#     results = Parallel(n_jobs=args.worker_num, verbose=10, prefer='threads')(delayed(generate_one_graph)(generator, i, model, outdir, args, repeat) for i,generator in enumerate(generator_list))
...
#     print("He terminado todos los procesos")
