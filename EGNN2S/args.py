...
def make_args():
    ...
    parser.add_argument('--task', dest='task', default='link', type=str,
                        help='link; node')
    parser.add_argument('--model', dest='model', default='EGNN', type=str,
                        help='model class name')
    parser.add_argument('--dataset', dest='dataset', default='grid', type=str,
                        help='grid; caveman; barabasi, cora, citeseer, pubmed')
    parser.add_argument('--data_name', dest='data_name', default='fuhs', 
                        help='Family name to use')
    ...
    parser.set_defaults(gpu=True, task='link', model='EGNN', dataset='Cora', cache=True,
